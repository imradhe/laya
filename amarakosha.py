...
sentence_csv_file = "SwaraSangraha/amarakosha/sentence_data.csv"
word_csv_file = "SwaraSangraha/amarakosha/word_data.csv"
audio_directory = "SwaraSangraha/amarakosha/audio"
